...
Public Class MsgboxCentrado_Screen
    Implements IDisposable

    Private mTries As Integer = 0
    Private mOwner As Screen

    Public Sub New(ByVal owner As Screen)
        mOwner = owner
        Dim t As New Task(AddressOf findDialog)
    End Sub
    ...
    Private Function checkWindow(ByVal hWnd As IntPtr, ByVal lp As IntPtr) As Boolean
        ...
        End If
        ' Got it
        Dim frmRect As Rectangle = mOwner.WorkingArea
        Dim dlgRect As RECT
