...
Friend Class clsFTP
    ...
    Public Sub New(ByVal host As String, dir As String, ByVal user As String, ByVal pass As String, Optional port As String = "21")
        ...
        Try
            ...
            If lista.Length = 1 AndAlso lista(0).ToString.ToUpper.StartsWith("ERROR") Then
                'ULMALGFree.clsLogsCSV.txtResponse = lista(0).Replace("ERROR", "").Replace(vbCrLf, "").Trim
                conexionOk = False
            Else
                conexionOk = True
            End If
    ...
    Public Function DescargarFicheroFTP(ByVal DirFtp As String, ByVal user As String,
            ...
            Optional ByRef quePb As ProgressBar = Nothing) As String
        ...
        Try
            Using response As System.Net.FtpWebResponse = CType(ftp.GetResponse, System.Net.FtpWebResponse)
                Using responseStream As IO.Stream = response.GetResponseStream
                    If quePb IsNot Nothing Then quePb.Maximum = CInt(responseStream.Length)
    ...
    Public Function FTP_ListaDir(ByVal queDir As String) As String()
    ...
    Public Function FTP_DameDatosFichero(ByVal queFichero As String, ByVal queDato As queDatoFichero) As String
        Dim resultado As String = ""
        Dim peticionFTP As FtpWebRequest
        Try
            ' Creamos una peticion FTP con la dirección del objeto que queremos saber si existe
